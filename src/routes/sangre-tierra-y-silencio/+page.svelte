...
<div class="min-h-screen bg-[var(--color-paper)] transition-colors duration-300 {nightMode ? 'reading-dark' : ''}">
  <main>
    <div class="relative w-full h-[calc(100vh-5rem)] md:h-[calc(100vh-6rem)] mt-20 md:mt-24 overflow-hidden">
      <img src="/james-lee-YpDkIh137ws-unsplash.jpg" alt="" class="absolute inset-0 w-full h-full object-cover blur-sm scale-110" />
      ...
      <div class="relative z-10 flex items-center justify-center h-full px-6">
        <div class="flex flex-col items-center">
          ...
          <p class="text-xs text-center uppercase tracking-[2px] text-white mt-6" style="font-family: 'Inter', sans-serif; font-weight: 500;">Por Florencia Leiva Silva</p>
          <p class="text-[11px] text-center uppercase tracking-[2px] text-white/70 mt-1" style="font-family: 'Inter', sans-serif; font-weight: 500;">Enero, 2025</p>
        </div>
      </div>
    </div>
