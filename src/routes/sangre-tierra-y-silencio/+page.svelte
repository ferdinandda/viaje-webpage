...
<div class="min-h-screen pt-32 md:pt-40 bg-[var(--color-paper)]">
  <main>
    <div class="container mx-auto px-4 py-8">
      <p class="text-xs font-bold text-center text-[#9C9C9C] mb-2 font-['Jost'] uppercase tracking-widest">Feminismos</p>
      ...
      <div class="text-lg leading-relaxed mb-4 text-justify font-['Jost'] mx-auto max-w-prose font-light">
        ...
        <p class="mb-6">La concepción moderna de la menstruación delinea “problemas” que en apariencia se “resuelven” por obra y gracia de los productos higiénicos comerciales. Asimismo, el tachado de sus flujos naturales, junto con su ingreso en el sistema capital del trabajo desestabiliza el sistema de cohesión entre mujer y naturaleza, profundizando también, inadvertidamente, el problema de la crisis medioambiental. Avanzo así, desde esta genealogía clásica, y me pregunto si es que es posible alinear el doble vínculo de la menstruación con el modelo de las tres ecologías planteado por Felix Guattari con el fin de tensionar la relación entre humanidades ambientales y feminismo.</p>
        
        <p class="mb-6">Expongo resumidamente el sistema que Guattari denomina como “ecosofía”. El autor da inicio a sus reflexiones con una descripción del actual desequilibrio ecológico a modo de crítica ante la inoperancia del aparato político y ejecutivo frente al problema ambiental en su complejidad. Ante esto, se propone un modelo de pensamiento de colaboración entre tres registros ecológicos para reorientar la solución a este problema: medio ambiente, relaciones sociales y subjetividad humana (mental). Utilizamos entonces el modelo de Guattari con el fin de repensar tanto el estadio actual de la crisis ambiental de la tierra como la situación de la mujer en la sociedad actual más allá de la eco-crítica clásica.</p>
